...
@section('content')
    <div class="content-wrapper">
        <div class="container-fluid">
            <form action="{{ route('magazineMG.update',['magazineMG'=>$magazineMG]) }}" method="post" enctype="multipart/form-data">
                @method('PATCH')
                @csrf
                <div class="col-12">
                ...
                <div class="form-row">
                    ...
                    <div class="form-group col-12 col-md-4 col-lg-3 col-xl-2">
                        ...
                        <div class="form-group">
                            <input type="number" class="form-control" id="id" name="id" value="{{ $magazineMG->id }}">
                        </div>
                    ...
                    <div class="form-group col-12 col-md-4 col-lg-2 col-xl-2">
                        ...
                        <div class="custom-file">
                            ...
                            <label class="custom-file-label" for="magazineFile">{{ $magazineMG->file }}</label>
                        </div>
                    ...
                    <div class="form-group col-12 col-md-4 col-lg-2 col-xl-2">
                        <h3>雜誌檔案(簡)</h3>
                        <div class="custom-file">
                            <input type="file" class="custom-file-input" id="magazine_gb_File" name="gb_file">
                            <label class="custom-file-label" for="magazine_gb_File">{{ $magazineMG->gb_file }}</label>
                        </div>
                    ...
                    <div class="form-group col-12 col-md-4 col-lg-3 col-xl-2">
                        ...
                        <div class="custom-file">
                            ...
                            <label class="custom-file-label" for="imageFile">{{ $magazineMG->image }}</label>
                        </div>
                    ...
                    <div class="form-group col-12 col-md-4 col-lg-3 col-xl-2">
                        ...
                        <div class="custom-file">
                            ...
                            <label class="custom-file-label" for="imageBFile">{{ $magazineMG->image_b }}</label>
                        </div>
                ...
                <div class="form-group">
                    ...
                    <textarea class="form-control" rows="5" id="comment" name="intro">{!! $magazineMG->intro !!}</textarea>
                </div>
