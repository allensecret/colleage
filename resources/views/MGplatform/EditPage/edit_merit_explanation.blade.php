...
@section('navbar')
    <ol class="breadcrumb">
        ...
        <li class="breadcrumb-item text_label"><b>使用說明</b></li>
    </ol>
@endsection
@section('content')
    @include('MGplatform.layouts.alert')
    <div class="content-wrapper">
        <form class="container-fluid" action="{{ route('edit_merit_explanation_save',['type'=>'merit_explanation']) }}" method="post">
            @csrf
            <div class="row">
                <div class="col-8">
                    <h2>使用說明</h2>
                ...
                <div class="col-4">
                    @can('edit_merit_explanation.update')
