...
<div class="wrapper fadeInDown">
    ...
    <div id="formContent">
        ...
        <!-- Login Form -->
        <form action="{{ route('MGPlatform.login') }}" method="post">
            @csrf
        ...
        <div class="text-center pb-3"><a href="{{ route('index') }}" style="font-size: 1.3rem;color: #e9aa0b">!!非行政人員 點此返回佛陀教育網路學院 </a></div>
    </div>
</div>
